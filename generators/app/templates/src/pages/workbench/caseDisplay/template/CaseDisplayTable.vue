...
<template>
    <section class="wrap">
        ...
        >
            ...
            <el-table-column prop="inKsName" show-overflow-tooltip label="入院科室" :min-width="80"></el-table-column>
            <el-table-column prop="inKsName" show-overflow-tooltip label="出院科室" :min-width="80"></el-table-column>
