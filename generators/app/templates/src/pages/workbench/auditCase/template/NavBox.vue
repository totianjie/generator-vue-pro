...
<script>
    ...
    export default {
        ...
        props: {
            ...
            navWidth: { // 菜单名称 all全部病例 sysFirst系统初审 hopFirst医院初审 review复审 hopSec医院复审 expert专家审核 result最终结论
                type: Number,
                default: 0
            }
        },
        ...
        methods: {
            ...
            _getNavWidth (dom) { // 获取最外层宽度
                // this.navWrapWidth = this.navWidth;
                if (this.page !== 'all') {
                    this.navWrapWidth = this.navWrap.getBoundingClientRect().width - 350;
                } else {
            ...
            handlerNext () { // 下一页
                // debugger;
                console.log(this.listWrapWidth, this.navWrapWidth);
