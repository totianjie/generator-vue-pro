...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['chargeComparisonRight'])
        },
        watch: {
            chargeComparisonRight: function (newVal, oldVal) {
        ...
        created () {
            ...
            localRaw = localRaw ? JSON.parse(localRaw).standard : [...tableDataStandard.COST.standard];
