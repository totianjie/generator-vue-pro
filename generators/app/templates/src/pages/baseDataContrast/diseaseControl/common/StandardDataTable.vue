...
<script>
    ...
    export default {
        ...
        created () {
            ...
            localRaw = localRaw ? JSON.parse(localRaw).standard : [...tableDataStandard.DISEASE_CONTROL.standard];
            this.tableDataStandard = [...localRaw];
            console.log(`tableDataStandard >>>>`, localRaw);
        },
        computed: {
            ...mapGetters(['diseaseControlRight'])
        },
        watch: {
            diseaseControlRight: function (newVal, oldVal) {
        ...
        methods: {
            ...mapMutations(['setchargeComparisonRight']),
            ...mapActions(['addData']),
            // 某一行被双击
