    ...
    <div class="search-wrap">
        <v-search-box>
            <div class="clearfix">
                ...
                <el-col :span="span">
                    <v-input label="原始手术编码：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code1"  placeholder="请输入原始手术编码" :size="formSize"></el-input>
                    </v-input>
                </el-col>
                <el-col :span="span" class="m-t-8">
                    <v-input label="原始手术名称：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code2"  placeholder="请输入原始手术名称" :size="formSize"></el-input>
                    </v-input>
                </el-col>
                <el-col :span="span" class="m-t-8">
