    ...
    <div class="search-wrap">
        <v-search-box>
            <div class="clearfix">
                ...
                <el-col :span="span">
                    <v-input label="原始项目编码：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code1"  placeholder="请输入原始项目编码" :size="formSize"></el-input>
                    </v-input>
                </el-col>
                <el-col :span="span" class="m-t-8">
                    <v-input label="原始项目名称：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code2"  placeholder="请输入原始项目名称" :size="formSize"></el-input>
                    </v-input>
                </el-col>
                <el-col :span="span" class="m-t-8">
                ...
                <el-col :span="span" class="m-t-8">
                    <v-input label="原始剂型：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code5"  placeholder="请输入原始剂型" :size="formSize"></el-input>
                    </v-input>
                </el-col>
                <el-col :span="span" class="m-t-8">
                    <v-input label="标准剂型：" :span="8" :labelWidth="lableWidth">
                        <el-input v-model="code6"  placeholder="请输入标准剂型" :size="formSize"></el-input>
                    </v-input>
                </el-col>
            </div>
            <div slot="btn">
