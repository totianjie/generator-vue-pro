...
<script>
    ...
    import {getDict} from "../../../js/api/baseDataContrast/operation";
    ...
    export default {
        ...
        mounted () {
            ...
            busEvent.$on('baseDataContrast/operation/common/StandardData.standardData', (json = null) => {
                ...
                this.searchParams = Object.assign({}, this.searchParams, {operationName});
            });
            // 原始数据点击
            busEvent.$on('baseDataContrast/operation/common/RawDataTableMixins.rowClick', ({instOperationName} = {}) => {
                this.searchParams = Object.assign({}, this.searchParams, {instOperationName});
            });
        },
        methods: {
            handlerClear () { // 清空查询条件
