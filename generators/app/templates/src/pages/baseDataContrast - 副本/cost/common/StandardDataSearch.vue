<template>
    <v-search-box>
        <div>
            <el-col :span="span">
                <v-input label="标准批次：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <v-select
            ...
            <el-col :span="span" class="m-t-8">
                <v-input label="标准编码：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <el-input v-model="searchParams.catalogCode" placeholder="请输入标准编码" :size="formSize"></el-input>
                </v-input>
            </el-col>
            <el-col :span="span" class="m-t-8">
                <v-input label="标准名称：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <el-input v-model="searchParams.catalogName" placeholder="请输入标准名称" :size="formSize"></el-input>
                </v-input>
            </el-col>
        </div>
        <div slot="btn">
