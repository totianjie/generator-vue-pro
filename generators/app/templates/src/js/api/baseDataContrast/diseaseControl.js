 ...
 * @Date: 2018-08-29 10:13:26
 * @remark: 疾病对照
 * */
import {ajax} from './../ajax';

export const URL = {
    indexdict: '/common/indexdict',
    diseaseRelationList: '/diseaseRelation/list',
    audit: '/diseaseRelation/audit',
    cancelAudit: '/diseaseRelation/cancel/audit',
    getItemData: '/diseaseRelation/get',
    match: '/diseaseRelation/match',
    noMatch: '/diseaseRelation/no/match',
    statistics: '/diseaseRelation/statistics',
    standardList: '/standard/list',
    submit: '/diseaseRelation/save',
    manytoone: '/diseaseRelation/manytoone',
    onetomany: '/diseaseRelation/onetomany',
    exportTpl: '/diseaseRelation/templet/export',
    upload: '/diseaseRelation/upload',
    synAuditDataByBatchNo: '/diseaseRelation/synAuditData/batchNo', // {batchNo: ""}
    synAuditDataByIds: '/diseaseRelation/synAuditData/ids', // {auditId: "1;2;3;4"}
    matchingCatalog: ''
