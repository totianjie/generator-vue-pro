...
<template>
    <v-search-box>
        <div>
            ...
            <el-col :span="span">
                <v-input label="原始手术编码：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <el-input v-model.trim="searchParams.instOperationCode" placeholder="请输入原始手术编码" :size="formSize"></el-input>
                </v-input>
            </el-col>
            <el-col :span="span" class="m-t-8">
                <v-input label="标准名称：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <el-input v-model.trim="searchParams.operationName" placeholder="请输入标准名称" :size="formSize"></el-input>
                </v-input>
            </el-col>
            <el-col :span="span" class="m-t-8">
                <v-input label="原始手术名称：" :span="5" :pxUnit="true" :labelWidth="lableWidth">
                    <el-input v-model.trim="searchParams.instOperationName" placeholder="请输入原始手术名称" :size="formSize"></el-input>
                </v-input>
            </el-col>
            <el-col :span="span" class="m-t-8">
        ...
        <table-col-setting ref="setting" type="operation"/>
    </v-search-box>
</template>
<script>
